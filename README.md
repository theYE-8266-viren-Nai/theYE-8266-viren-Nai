...
- <span style="color: #FFFF00;">💡</span> Interested in open-source contribution and collaborative development
- <span style="color: #FF6900;">🎯</span> Goal: Build scalable, user-friendly applications that solve real-world problems
...
<table style="font-family: 'Courier New', monospace; color: #FFFFFF; background: linear-gradient(45deg, #000033, #000066); border: 3px ridge #00FF00; border-collapse: collapse; width: 100%;">
  ...
  <tr>
    <td style="padding: 8px; border: 1px solid #00FFFF;"></td>
    <td style="padding: 8px; border: 1px solid #00FFFF;"></td>
  </tr>
  <tr>
    <td style="padding: 8px; border: 1px solid #00FFFF;"></td>
...
<table style="font-family: 'Courier New', monospace; color: #FFFFFF; background: linear-gradient(45deg, #000033, #000066); border: 3px ridge #FF00FF; border-collapse: collapse; width: 100%;">
  <tr><th colspan="2" style="background: #FF00FF; color: #000; padding: 10px; text-align: center; font-size: 18px;">Frameworks & Libraries</th></tr>
  <tr>
...
<div align="center" style="background: #001100; padding: 10px; border: 2px outset #FF00FF;">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=theYE-8266-viren-Nai&theme=gruvbox&hide_border=true" width="100%" alt="Contributions" />
</div>

## 🏆 GitHub Trophies

<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=theYE-8266-viren-Nai&theme=radical&no-frame=true&no-bg=true&margin-w=4&row=1" alt="Trophies" />
</div>

<hr style="border: 2px groove #00FFFF;">

## 🔗 Let's Connect

<p align="center" style="font-family: 'Courier New', monospace; color: #FFFF00; background: #330000; padding: 15px; border: 3px double #FFFF00; text-shadow: 0 0 10px #FFFF00;">
  ...
  <br><em>💬 Feel free to reach out if you want to collaborate on a project or just chat about tech!</em>
</p>

***

<div align="center" style="font-family: 'Courier New', monospace; color: #00FFFF;">
  <img src="https://komarev.com/ghpvc/?username=theYE-8266-viren-Nai&color=00ff00&style=flat-square&label=Profile+Views" alt="Views" />
</div>
